      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-4">
        <header className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-700 dark:text-slate-200">
              BERT
            </span>
          </Link>
          ...
          <nav className="hidden items-center gap-8 text-sm text-slate-600 dark:text-slate-300 md:flex">
            ...
            <span className="font-semibold text-slate-900 dark:text-slate-100">FAQ</span>
          </nav>

          <Link
            href="/"
            className="rounded-full bg-slate-900 px-5 py-2 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(15,23,42,0.16)] transition hover:-translate-y-0.5"
          >
            Launch App
          </Link>
        </header>
