...
import { communityContracts, communityFactoryAbi } from "@/lib/community-contracts";
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {filteredCommunities.map((community) => {
          const active = community.hub !== "0x0000000000000000000000000000000000000000";
          return (
            <Link
              key={community.id}
              href={active ? `${basePath}/${community.id}` : basePath}
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <span className={active ? "rounded-full border border-emerald-300/25 bg-emerald-400/10 px-3 py-1 text-xs font-semibold text-emerald-200" : "rounded-full border border-amber-300/25 bg-amber-400/10 px-3 py-1 text-xs font-semibold text-amber-100"}>
