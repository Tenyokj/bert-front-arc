...
export default function TreasuryPoliciesPage() {
  ...
  const { data: faucetClaimAmount } = useReadContract({
          ...
          <main className="space-y-12 border-t border-white/12 pt-8">
            <section id="live" className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <div className="rounded-xl border border-white/15 bg-white/[0.03] p-4 text-sm"><p className="text-slate-500">totalPoolBalance</p><p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{formatBtk(totalPoolBalance as bigint | undefined)} BTK</p></div>
                <div className="rounded-xl border border-white/15 bg-white/[0.03] p-4 text-sm"><p className="text-slate-500">protocolReserve</p><p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{formatBtk(protocolReserve as bigint | undefined)} BTK</p></div>
                ...
                <div className="rounded-xl border border-white/15 bg-white/[0.03] p-4 text-sm"><p className="text-slate-500">BTK totalSupply</p><p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{formatBtk(tokenSupply as bigint | undefined)} BTK</p></div>
                <div className="rounded-xl border border-white/15 bg-white/[0.03] p-4 text-sm"><p className="text-slate-500">BTK maxSupply</p><p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{formatBtk(tokenMaxSupply as bigint | undefined)} BTK</p></div>
                <div className="rounded-xl border border-white/15 bg-white/[0.03] p-4 text-sm"><p className="text-slate-500">Faucet claim/cooldown</p><p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{formatBtk(faucetClaimAmount as bigint | undefined)} BTK / {formatSeconds(faucetCooldown as bigint | undefined)}</p></div>
              </div>
            </section>
            ...
            <section id="sources" className="space-y-4">
              ...
              <p className="text-base leading-relaxed text-slate-700 dark:text-slate-200">
                Primary treasury state is represented in <strong>Funding Pool</strong>. Sources may include governance-token stake flow,
                protocol-directed funding inflows, and admin-synchronized balance updates where explicitly allowed by contract policy.
              </p>
              <p className="text-base leading-relaxed text-slate-700 dark:text-slate-200">
